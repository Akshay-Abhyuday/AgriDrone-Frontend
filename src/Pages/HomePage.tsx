...
const HomePage: React.FC = () => {
  ...
  // Handle scroll for drone links
  useEffect(() => {
    const params = new URLSearchParams(location.search);
    const tab = params.get('tab') as TabKey | null;
    const hash = location.hash;

    if (tab && ['Cleaning', 'Agriculture', 'Transport', 'Firefighting'].includes(tab)) {
      setActiveTab(tab);
    ...
    // Reset hasScrolled after a short delay
  ...
  return (
    <>
      ...
      {/* Real-World Challenges Section */}
      <section id="real-world-challenges" style={{ backgroundColor: '#f3f3f3', padding: '60px 20px', textAlign: 'center' }}>
        <div style={{ maxWidth: '900px', margin: '0 auto', color: '#000' }}>
          <h2 style={{ fontSize: '30px', fontWeight: 'bold', marginBottom: '20px' }}>
            Advanced Drones for Real-World Challenges
          </h2>
      ...
      {/* Tabs Section */}
      <section id="tabs-section" style={{ padding: '40px 20px', backgroundColor: '#fff', textAlign: 'center' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start' }}>
            <img
              src={tabContent[activeTab].image}
